...
export default async function AnimePage({ params }) {
    ...
    const lnk = `https://youtubeapi-tmc9.onrender.com/api/anime?q=${slug}&limit=1`
        ...
        <>
               <div id="detail-border">
                <div id="detail-player">
                    {cmData.map((item,index)=>{return(<AnimeDetail key={index} name={item.animeTitle} duration={item.duration} episodes={item.episodes} type={item.type} rating={item.rating} />)})}

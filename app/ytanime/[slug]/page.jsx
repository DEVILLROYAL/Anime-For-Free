        ...
        <>
               <div id="detail-border">
                <div id="detail-player">
                    {cmData.map((item,index)=>{return(<AnimeDetail key={index} name={item.engTitle ?? item.animeTitle} duration={item.duration} id={item.playlistId} episodes={item.episodes} type={item.type} rating={item.rating} />)})}
